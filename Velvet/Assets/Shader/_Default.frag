...
uniform DirLight dirLights[MAX_LIGHT_PER_TYPE];
uniform PointLight pointLights[MAX_LIGHT_PER_TYPE];
uniform SpotLight spotLights[MAX_LIGHT_PER_TYPE];
...
vec3 CalcDirLight(DirLight light, vec3 normal, vec3 viewDir)
{
    ...
    float shadow = ShadowCalculation(light.direction, FragPosLightSpace);
